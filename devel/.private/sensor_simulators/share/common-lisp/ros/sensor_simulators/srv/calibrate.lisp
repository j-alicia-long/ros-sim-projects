...
(cl:in-package sensor_simulators-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <calibrate-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'calibrate-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_simulators-srv:<calibrate-request> is deprecated: use sensor_simulators-srv:calibrate-request instead.")))

(cl:ensure-generic-function 'zero-val :lambda-list '(m))
(cl:defmethod zero-val ((m <calibrate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_simulators-srv:zero-val is deprecated.  Use sensor_simulators-srv:zero instead.")
  (zero m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<calibrate-request>)))
  ...
  "sensor_simulators/calibrateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'calibrate-request)))
  "Returns string type for a service object of type 'calibrate-request"
  "sensor_simulators/calibrateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <calibrate-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'calibrate-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_simulators-srv:<calibrate-response> is deprecated: use sensor_simulators-srv:calibrate-response instead.")))

(cl:ensure-generic-function 'baseline-val :lambda-list '(m))
(cl:defmethod baseline-val ((m <calibrate-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_simulators-srv:baseline-val is deprecated.  Use sensor_simulators-srv:baseline instead.")
  (baseline m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<calibrate-response>)))
  ...
  "sensor_simulators/calibrateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'calibrate-response)))
  "Returns string type for a service object of type 'calibrate-response"
  "sensor_simulators/calibrateResponse")
